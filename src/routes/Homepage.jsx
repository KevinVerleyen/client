...
const Homepage = () => {
  return (
    <div className="mt-4 flex flex-col gap-4"> {/* Conteneur principal avec des classes Tailwind */}
      ...
      <div className="flex gap-4">
        ...
        <span className="text-blue-800">Blogs et Articles</span> {/* Texte actuel pour indiquer la section */}
      </div>

      {/* INTRODUCTION - Section introductive avec un titre et une description */}
      <div className="flex items-center justify-between"> {/* Mise en page entre texte et bouton */}
        {/* TITRES */}
        <div className=""> {/* Conteneur du titre */}
          <h1 className="text-gray-800 text-2xl md:text-5xl lg:text-6xl font-bold">
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
          </h1> {/* Grand titre */}
          <p className="mt-8 text-md md:text-xl">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium soluta,
          </p> {/* Sous-titre ou description */}
        </div>

        {/* ANIMATED BUTTON - Bouton animé avec un effet circulaire */}
        <Link to="write" className="hidden md:block relative"> {/* Lien pour naviguer vers une page de rédaction */}
          <svg
            viewBox="0 0 200 200"
            width="200"
            height="200"
          ...
          >
            ...
            <text>
              <textPath href="#circlePath" startOffset="0%">Mon Pense-Bête</textPath>
              <textPath href="#circlePath" startOffset="50%">Pour Dev ° ° °</textPath>
            </text> {/* Texte animé autour du cercle */}
          </svg>
          <button className="absolute top-0 left-0 right-0 bottom-0 m-auto w-20 h-20 bg-fuchsia-950 hover:bg-fuchsia-800 rounded-full flex items-center justify-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <line x1="6" y1="18" x2="18" y2="6" />
              <polyline points="9 6 18 6 18 15" />
            </svg> {/* Icône de flèche indiquant l'action */}
          </button>
        </Link>
      </div>
      ...
      <div className="">
        <h1 className="my-b text-2xl text-gray-600">Recent Posts</h1> {/* Titre pour la section */}
